      ...
      <section class="hero">
        <div class="container">
          <div class="hero-content">
            ...
            <h1 class="hero-title">Engineering Teams</h1>
            <p class="hero-subtitle">Streamline development workflows with integrated project management, code collaboration, and automated testing pipelines designed specifically for engineering teams.</p>
      ...
      <section class="features-section">
        <div class="container">
          <div class="section-header">
            <h2 class="section-title">Built for Engineering Teams</h2>
            <p class="section-subtitle">Everything you need to manage complex development projects and deliver high-quality software</p>
          </div>
          <div class="features-grid">
            ...
            <div class="feature-card">
              ...
              <p>Seamlessly connect with your existing development tools and automate your deployment pipeline</p>
              <ul class="feature-list">
                <li>GitHub, GitLab, and Bitbucket integration</li>
                <li>Automated testing and deployment</li>
                <li>Build status and deployment tracking</li>
              </ul>
            </div>
            <div class="feature-card">
              <div class="feature-icon">
              ...
              <p>Review code, track changes, and collaborate effectively with your development team</p>
              <ul class="feature-list">
                <li>Pull request management</li>
                <li>Code review workflows</li>
                <li>Issue tracking and bug management</li>
              </ul>
            </div>
            <div class="feature-card">
              <div class="feature-icon">
              ...
              <p>Get insights into your team's performance and project progress with detailed analytics</p>
              <ul class="feature-list">
                <li>Velocity and throughput metrics</li>
      ...
      <section class="how-it-works">
        <div class="container">
          <div class="section-header">
            ...
            <p class="section-subtitle">From planning to deployment, CollabX streamlines your entire development process</p>
          </div>
          <div class="steps-grid">
            <div class="step-card">
              <div class="step-number">1</div>
              <h3>Plan & Prioritize</h3>
              <p>Create user stories, estimate effort, and plan sprints with integrated backlog management</p>
            </div>
            <div class="step-card">
              <div class="step-number">2</div>
              <h3>Develop & Collaborate</h3>
              <p>Code together with real-time collaboration, pull requests, and automated testing</p>
            </div>
            <div class="step-card">
              <div class="step-number">3</div>
              <h3>Test & Deploy</h3>
              <p>Automate testing, track deployments, and monitor application performance</p>
            </div>
            <div class="step-card">
              <div class="step-number">4</div>
              <h3>Monitor & Improve</h3>
              <p>Analyze performance metrics, gather feedback, and continuously improve your process</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="cta">
        <div class="container">
          <div class="cta-content">
            <h2 class="cta-title">Ready to streamline your engineering workflow?</h2>
            <p class="cta-subtitle">Join thousands of engineering teams who've transformed their development process with CollabX</p>
